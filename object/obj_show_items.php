...
while($Row=mysql_fetch_array($Query)) {
    ...
    //--------------------------------------------
    ?>
    <div class="width-100 makeBlock" id="<?php echo $itemID.$itemsloop; ?>">
        <div class="photoframe1"><a href="view.php?p=<?php echo $myID; ?>"><img src="<?php echo $PictureThumb1; ?>" style="width:100%;"></a></div>
        <div class="photoframe1x">
            <div class="categoryTags1 pull-left tagbox1x"><?php echo $arTopMenuCatNameByID[$myCategoryID]; ?></div>
            <a href="view.php?p=<?php echo $myID; ?>"><img src="<?php echo $PictureThumb2; ?>" style="width:100%;"></a>
        </div>
        <div class="text-left linkbox1">
            <div class="makeBlock tagbox1"><div class="categoryTags1 pull-left"><?php echo $arTopMenuCatNameByID[$myCategoryID]; ?></div></div>
            <a href="view.php?p=<?php echo $myID; ?>" class="picturelink"><?php echo $mySubject; ?></a>
        </div>
    </div> 
    <div class="boxindent1" id="<?php echo $itemID.$itemsloop; ?>i1"></div>
    <div class="boxindent2" id="<?php echo $itemID.$itemsloop; ?>i2"></div>
    <?php
    $itemsloop++;
}
?>