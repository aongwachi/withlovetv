...
while($Row=$query->fetch()) {
    ...
    if($itemsloop==1) {
        ...
        <div class="fb-border" id="<?php echo $itemID.$itemsloop; ?>">
            ...
            <div class="text-left linkbox-basica_big">
                <div class="bt-playarea-basica_big text-center bg-red" onclick=" location.href='/<?php echo $myID; ?>/'; ">
                    <?php if($isVideo) { ?>
                ...
                <div class="row width-100 bg-green">
                ...
                <div class="row width-100 bg-blue">
        ...
        <div class="fb-border" id="<?php echo $itemID.$itemsloop; ?>">
            ...
            <div class="width-100 row itemspanel-basicax">
                ...
                <div class="bt-playarea-basicax" onclick=" location.href='/<?php echo $myID; ?>/'; ">
                    ...
                    <?php } else { ?>
                    <a href="/<?php echo $myID; ?>/"><img src="img/blank.png" style=" width:100%; height: 30px; " border="0" /></a>
                    <?php } ?>
                </div>
