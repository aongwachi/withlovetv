<?php
#############################################################################################################################################
$sqlSettingMenu=" FROM ".TABLE_MENU." WHERE ".TABLE_MENU."_Name<>'' AND ".TABLE_MENU."_Link<>'' AND ".TABLE_MENU."_Type='Setting' ";
...
#############################################################################################################################################
?>
<ul class="drop-right Object_NavBarRightDropDown" id="idObject_NavBarRightDrop1Sub" style=" width:180px; height:<?=$SettingMenuHeight?>px; margin-top: 5px; padding: 6px; ">
<div class="padding-3 text-right" style=" color: #508908; font-size: 10px; font-weight: bold; ">Menu</div>
