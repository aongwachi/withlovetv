...
while($Row=mysql_fetch_array($Query)) {
    ...
    //--------------------------------------------
    ?>
        <div class="photoframe0"><a href="view.php?p=<?php echo $myID; ?>"><img src="<?php echo $PictureThumb; ?>" style=" height:100%; width:100%; "></a></div>
        <div class="text-left linkbox0"><a href="view.php?p=<?php echo $myID; ?>" class="picturelink"><?php echo $mySubject; ?></a></div>
