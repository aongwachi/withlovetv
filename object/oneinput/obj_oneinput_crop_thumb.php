...
<div class="padding-0" style=" padding-bottom: 10px;">
    <div id="id<?php echo $Config_UniqueID; ?>AreaFile" class="padding-0 pull-left">
        <div style=" width:200px; height:350px; padding: 0px; ">
            <div id="cropContainerPreload<?php echo $Config_UniqueID; ?>"  style=" width:200px; height:350px; "></div>
        </div>
        <script>
        var croppicContainerPreloadOptions = {
            ...
            cropUrl:'img_crop_to_file_thumb.php',
