...
<div class="padding-0" style=" padding-bottom: 10px;">
    ...
    if($Config_DefaultValue<>"") {
        ...
        if($myCropWidth>$Config_CropWidth || $myCropHeight>$Config_CropHeight) {
            ?>
            <div style=" width:<?php echo $Config_CropWidth+8; ?>px; height:<?php echo $Config_CropHeight+8; ?>px; padding: 0px; ">
            <div id="cropContainerPreload<?php echo $Config_UniqueID; ?>"  style=" width:<?php echo $Config_CropWidth+8; ?>px; height:<?php echo $Config_CropHeight+8; ?>px; "></div>
            </div>
            <script>
            ...
            ?>
            <div style=" width:<?php echo $Config_CropWidth; ?>px; height:<?php echo $Config_CropHeight; ?>px; padding: 0px; ">
            <img src="<?=$Config_Path.$Config_DefaultValue?>" >
            </div>
            <?php
        }
