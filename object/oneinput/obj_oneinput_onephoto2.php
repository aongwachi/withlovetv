    ...
    if($Config_DefaultValue<>"") {
        ...
        if($myCropWidth>$Config_CropWidth || $myCropHeight>$Config_CropHeight) {
            ...
            <div style=" display:block; ">
                <button class="btn btn-info btn-flat pull-left" style=" margin-top:7px; " onclick=" $('#idForm<?php echo $Config_UniqueID; ?>').submit(); ">
            ...
            <script>
            $(function(){ $('#cropbox<?php echo $Config_UniqueID; ?>').Jcrop({ aspectRatio: <?php echo $Config_CropWidth; ?>/<?php echo $Config_CropHeight; ?>, onSelect: updateCoords<?php echo $Config_UniqueID; ?> }); });
            ...
            function checkCoords<?php echo $Config_UniqueID; ?>() { $('#idTest<?php echo $Config_UniqueID; ?>').val($(document).scrollTop()); if (parseInt($('#w<?php echo $Config_UniqueID; ?>').val())) return true; alert('Please select a crop region then press submit.'); return false; };
            </script>
            <form action="upload-jcorp.php" method="post" id="idForm<?php echo $Config_UniqueID; ?>" onsubmit="return checkCoords<?php echo $Config_UniqueID; ?>();">
            ...
            <input type="hidden" name="Config_DefaultPath" value="<?php echo $Config_DefaultPath; ?>" />
            <input type="hidden" name="Config_DefaultValue" value="<?php echo $Config_DefaultValue; ?>" />
            ...
            ?>
            <div id="id<?php echo $Config_UniqueID; ?>AreaFile" class="padding-0 pull-left">
            <img src="<?php echo $Config_Path.$Config_DefaultValue; ?>" >
            </div>
            <?php
        }
