...
//------------------------
?>
<div id="id<?php echo $Config_Input_Key; ?>AreaFile">
...
$('#input<?php echo $Config_Input_Key; ?>').on('change', function() {
    CurrentUseFile=$('#id<?php echo $Config_Input_Key; ?>AreaFile').html();
    CurrentUsePhoto='-1';
    $('#id<?php echo $Config_Input_Key; ?>AreaFile').html('<img src="<?php echo SYSTEM_WEBPATH_ROOT; ?>/img/loading.gif" >');
    $('#myUploadForm<?php echo $Config_Input_Key; ?>').submit();
    showValidFile('<?php echo $Config_Input_Key; ?>');
});
</script>