...
*/
//--------------------------------------------
$Config_Input_Zero=sprintf("%04d", $Config_Input_ID);
$Config_Input_Folder0=substr($Config_Input_Zero,strlen($Config_Input_Zero)-2,2);
$Config_Input_Folder1=substr($Config_Input_Zero,strlen($Config_Input_Zero)-4,2);
$Config_Input_Folder = SYSTEM_DOC_ROOT."upload/";
if(!file_exists($Config_Input_Folder)){ mkdir($Config_Input_Folder); chmod($Config_Input_Folder,0777); }
$Config_Input_Folder = SYSTEM_DOC_ROOT."upload/".$Config_Input_Folder0."/";
if(!file_exists($Config_Input_Folder)){ mkdir($Config_Input_Folder); chmod($Config_Input_Folder,0777); }
