...
<div class="thumb" style="height: 200px"><img style="height: 200px;width: 250px" src="<?php echo !empty($arContentThumb[$cindex])&&$arContentThumb[$cindex]?$arContentThumb[$cindex]:'upload/thumb2/00/30/default-thumbnail.jpg'; ?>" /></div>
