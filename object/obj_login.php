...
<div class="row width-100">
	...
	<div style=" padding-bottom: 20px; padding-top: 20px; " id="idLogin1">
		...
		<br>
		<img src="<?php echo SYSTEM_WEBPATH_TEMPLATES; ?>/img/text-big-cascap-clouds.png" class="pull-center" width="152" height="102" />
		<br>
	    </div>
    ...
    <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-1 col-md-6 col-md-offset-0 col-lg-6 col-lg-offset-0 text-center">
    	...
    	<br />
    	<br />
	<img src="<?php echo SYSTEM_WEBPATH_TEMPLATES; ?>/img/text-big-cascap-clouds.png" width="345" height="135" class="img-responsive pull-center" />
    </div>    
</div>
<br />
<br />