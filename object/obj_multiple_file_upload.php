...
<div class=" hidden-xs col-sm-3 col-md-6 col-lg-6 padding-2 text-right" style=" padding-top: 7px;">
    <input type="checkbox" class="toggle">
</div>
<div class="hidden-xs col-sm-3 col-md-2 col-lg-2 padding-2">
    <button type="button" class="btn btn-danger btn-block btn-flat delete"><span>Delete All</span></button>
</div>
</div>
    ...
    <td>
        {% if (file.deleteUrl) { %}
            ...
            <button class="btn btn-danger btn-flat delete" data-type="{%=file.deleteType%}" data-url="{%=file.deleteUrl%}"{% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
                <i class="glyphicon glyphicon-trash hidden-sm hidden-md hidden-lg"></i>
                <span>Delete</span>
            </button>
        {% } else { %}
            <button class="btn btn-warning btn-flat cancel">
