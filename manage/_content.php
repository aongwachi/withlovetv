...
if($SystemSession_Staff_ID>0) { 
    ...
    if($cid>0) {
		...
		<div class="pull-center padding-0 text-left" style=" max-width:1080px; ">
			...
			<div class="form-group width-100" style=" padding-left:0px; ">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left" style=" padding-left:0px; ">
					<b>ภาพหน้าแนวตั้ง (Featured) : </b> กำหนดให้ใช้ขนาด <?php echo $Config_CropWidth; ?>x<?php echo $Config_CropHeight; ?> pixel
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" style=" padding-left:20px; padding-top:20px; ">
					<?php
					//--------------------------------------------
			...
			<div class="form-group width-100" style=" padding-left:0px; ">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left" style=" padding-left:0px; ">
					<b>ภาพแนวนอน (FaceBook) : </b> กำหนดให้ใช้ขนาด <?php echo $Config_CropWidth; ?>x<?php echo $Config_CropHeight; ?> pixel
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" style=" padding-left:20px; padding-top:20px; ">
					<?php
					//--------------------------------------------
			...
			<div class="form-group width-100" style=" padding-left:0px; ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left" style=" padding-left:0px; ">
					...
					while($Row1=mysql_fetch_array($Query1)) {
						?>
						<div class="cursor pull-left border-radius-5 <?php if(strpos(" ".$myCategory,", ".$Row1[TABLE_CATEGORY."_ID "].", ")>0) { echo ' tagsYes '; } else { echo ' tagsNo '; } ?>" id="idTag<?php echo $Row1[TABLE_CATEGORY." _ID "]; ?>" style=" padding-left:15px; padding-right:15px; " onclick="setTags('<?php echo $Row1[TABLE_CATEGORY." _ID "]; ?>')">
