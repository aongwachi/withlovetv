...
$System_AjaxFileAction="ajax-live-loaddata.php";
...
if($SystemSession_Staff_ID>0 && $SystemSession_Staff_Level=="Admin") { 
	...
	$FooTableASCDESC='ASC';
	$FooTableOrderBy=TABLE_LIVE."_ID";
	//----------------------------------------------------------------------------------------------------------------
	?><br>
	<!---###############################################################################--->
	...
	<span class="glyphicon glyphicon-plus"></span> เพิ่มลิงค์ถ่ายทอดสดใหม่</button>
	</div>
	...
	<div class="panel-heading panel-custom-heading font-white" style=" background-color:<?php echo $myBGColor; ?>; color:#FFFFFF; text-align:left; height:80px; position:relative; ">
		<i class="glyphicon glyphicon-flash pull-left padding-10" style="font-size:40px; padding-right:20px;"></i>
		<h2 class="font-white"><strong>Live</strong></h2> <span> ลิงค์ถ่ายทอดสด</span>
	...
	<div class="panel-body panel-custom-body padding-10" style="padding-top:10px; padding-bottom:10px; " id="idTableCalendar"> 
		...
		<div class="input-group width-100 padding-5" style="padding-left:0px; padding-right:0px;">
			<input type="text" id="search" name="search" class="form-control border-info font-18 text-center" style=" height:40px; " placeholder="ค้นหาจาก ลิงค์ถ่ายทอดสด">
		...
		<th data-toggle="true" style="max-width:60px;">
                <a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_LIVE."_ID"; ?>"><i></i>#</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_LIVE."_Title"; ?>"><i></i>Title</a></th>
	...
	//----------------------------------
		dialogPopWindow = BootstrapDialog.show({
			title: 'แก้ไขข้อมูลลิงค์ถ่ายทอดสด',
			draggable: true,
