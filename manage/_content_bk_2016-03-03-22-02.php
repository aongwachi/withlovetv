...
if($SystemSession_Staff_ID>0) { 
    ...
    if($cid>0) {
		...
		<div class="pull-center padding-0 text-left" style=" max-width:1080px; ">
			...
			<!-------------------------------------------------------->
			<?php
			$savehtmlmyi=""; $savehtmlmyuniqueid=""; $savehtmltheID="";
							...
							//----------------------------------------
							    ...
							    tinymce.init({
									...
									theEditor.on('blur', function () {
									    ...
									    <?php
									    $savehtmlmyi=$i;
									    $savehtmlmyuniqueid=$Config_UniqueID;
									    $savehtmltheID=$myID;
									    ?>
									});
		...
		//----------------------------------------
		    ...
		    $.ajax({
			    ...
			    data: {
				    ...
				    myAjaxKey: <?php echo $savehtmlmyi; ?>,
				    myAjaxID: '<?php echo $myID; ?>',
				    myAjaxValue: markup
			    },
			    success: function(result) {
				    if (result == '') {
					    ...
					    $('#idAutoSave<?php echo $savehtmlmyuniqueid; ?>').html('<font color="#00AA00">' + result + '</font>');
					    $('#idAutoSave<?php echo $savehtmlmyuniqueid; ?>').show("slide", { direction: 'right', easing: 'easeOutCirc' }, 500).delay(1000).fadeOut(1000);
					    return true;
				    }
			    }
		    });
