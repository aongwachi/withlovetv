...
$myMenuKey="Staff";
$System_AjaxFileAction="ajax-staff-loaddata.php";
...
if($SystemSession_Staff_ID>0 && $SystemSession_Staff_Level=="Admin") { 
	...
	$FooTableOrderBy=TABLE_STAFF."_ID";
	//----------------------------------------------------------------------------------------------------------------
	?>
	<!---###############################################################################--->
	...
	<div class="panel-heading panel-custom-heading font-white" style=" background-color:<?php echo $myBGColor; ?>; color:#FFFFFF; text-align:left; height:80px; position:relative; ">
		<i class="fa fa-user pull-left padding-10" style="font-size:40px; padding-right:20px;"></i>
		<h2 class="font-white"><strong>Staff</strong></h2> <span> รายชื่อผู้ใช้งานระบบ</span>
	...
	<div class="panel-body panel-custom-body padding-10" style="padding-top:10px; padding-bottom:10px; " id="idTableCalendar"> 
		...
		<!---------------------------------------------------------------------------------------------------------------->
		<th data-toggle="true" style="max-width:60px;"><a href="javascript:void(0)" class="Link_FooTableActive" data-sort="<?php echo TABLE_STAFF."_ID"; ?>">
		<i class="glyphicon glyphicon-chevron-up font-10 padding-4"></i>#</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_STAFF."_Name"; ?>"><i></i>Name</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_STAFF."_User"; ?>"><i></i>Username</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_STAFF."_Level"; ?>"><i></i>Level</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_STAFF."_LastUpdate"; ?>"><i></i>LastUpdate</a></th>
