...
$System_AjaxFileAction="ajax-content-templates-loaddata.php";
...
if($SystemSession_Staff_ID>0 && $SystemSession_Staff_Level=="Admin") { 
	...
	$FooTableASCDESC='ASC';
	$FooTableOrderBy=TABLE_CONTENT_TEMPLATES."_Name";
	//----------------------------------------------------------------------------------------------------------------
	?><br>
	<!---###############################################################################--->
	...
	<span class="glyphicon glyphicon-plus"></span> เพิ่มเท็มเพลตใหม่</button>
	</div>
	...
	<div class="panel-heading panel-custom-heading font-white" style=" background-color:<?php echo $myBGColor; ?>; color:#FFFFFF; text-align:left; height:80px; position:relative; ">
		...
		<h2 class="font-white"><strong>Content Templates</strong></h2> <span> เท็มเพลต</span>
	...
	<div class="panel-body panel-custom-body padding-10" style="padding-top:10px; padding-bottom:10px; " id="idTableCalendar"> 
		...
		<div class="input-group width-100 padding-5" style="padding-left:0px; padding-right:0px;">
			<input type="text" id="search" name="search" class="form-control border-info font-18 text-center" style=" height:40px; " placeholder="ค้นหาจาก ชื่อเท็มเพลต">
		...
		<th data-toggle="true" style="max-width:60px;">
                <a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_CONTENT_TEMPLATES."_ID"; ?>"><i></i>#</a></th>
		<th><a href="javascript:void(0)" class="Link_FooTable" data-sort="<?php echo TABLE_CONTENT_TEMPLATES."_Name"; ?>"><i></i>Name</a></th>
