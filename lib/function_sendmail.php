...
$m->Attach( "/home/images/pic.gif", "image/gif" ) ; // attach a file of type image/gif
...
function To( $to ) {
// TODO : test validit&eacute; sur to
if( is_array( $to ) )
$this->sendto= $to;
else
$this->sendto[] = $to;
...
* default to us-ascii
* $mail->Body( "m&eacute;l en fran&ccedil;ais avec des accents", "iso-8859-1" );
*/

function Body( $body, $charset="" , $contenttype="") {
$this->body = $body;
if( $charset != "" ) {
