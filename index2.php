    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5">
            <div class="video-info">
                ...
                <div class="desc">
                    <label><span aria-hidden="true" class="glyphicon glyphicon-play text-pink"></span> Auto Play</label> ความละเอียด :  <?php echo $myLiveResolution; ?>k
                    <br />
                    <br />
                    <br />
                    <br />
                ...
                <ul class="list-playlist">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <div class="desc"> เพลงชาติไทยรัฐทีวี </div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <div class="desc"> เดินหน้าประเทศไทย </div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <div class="desc"> เจ้าแม่กวนอิม </div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            ...
                            <div class="desc"> ไทยรัฐ นิวส์โชว์ </div>
                            <div class="clearfix"></div>
                        </a>
                    </li>
                </ul>
    ...
    if($i%3==1) {
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="box">
                ...
                <div class="box-inner bg-lightgray"><?php $cindex=1; include("object/obj_items_big.php"); ?></div>
            </div>
            <div class="bottom-20"></div>
            <div class="row">
        ...
        <div class="col-xs-12 col-sm-3">
            <div class="box">
                ...
                <div class="box-inner bg-white"><?php $cindex=1; include("object/obj_items_basic.php"); ?></div><div class="bottom-15"></div>
                <div class="box-inner bg-white"><?php $cindex=2; include("object/obj_items_basic.php"); ?></div><div class="bottom-15"></div>
                <div class="box-inner bg-white"><?php $cindex=3; include("object/obj_items_basic.php"); ?></div>
            </div>
        </div>
        <?php
    }
